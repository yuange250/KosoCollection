export const WORLDSCENE_POI_OVERRIDES = {
  'forbidden-city': {
    searchTerms: ['Forbidden City', 'Palace Museum Beijing', '紫禁城', '北京故宫'],
    requiredTerms: ['forbidden city', 'palace museum', '紫禁城', '故宫'],
  ...
  'eiffel-tower': {
    searchTerms: ['Eiffel Tower', 'Tour Eiffel', '巴黎铁塔', '艾菲尔铁塔'],
