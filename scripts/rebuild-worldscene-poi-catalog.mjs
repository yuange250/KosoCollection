...
const KNOWN_BAD_IMAGE_HASHES = new Set([
  '77B463728B31A8D0966AFDE2C567F223032E7CB46BA1FA14898102FE9F680463',
  '7CB2C62410C46DFA2D5DDB42E4A3CFB36AD3A03656A161BEC005BD8765C02AE2',
  '8136FEA9B547C99C31A980592289571224D0CF5B46426F5BEC0700324775679F',
  '8E84649798BAB4222DFD3754232DEDF6F5E0C7F78756EC076FA6E864A402EA60',
]);
...
function isKnownBadLocalImage(file) {
...
function main() {
  ...
  const existingManifest = fs.existsSync(MANIFEST)
  ...
  for (const file of files) {
    ...
    if (!match) continue;
    if (isKnownBadLocalImage(file)) continue;
